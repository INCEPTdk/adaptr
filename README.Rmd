...
`plot_metrics_ecdf()` function. Finally, the `plot_convergence()` function may
be used to visually assess stability of performance metrics according to the
number of simulations. The `check_remaining_arms()` function may be used to
