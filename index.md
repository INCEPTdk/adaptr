# adaptr ![](reference/figures/adaptr.png)
...
parameter in a trial specification towards any performance metric.
...
method, which comes with a
[`print()`](https://inceptdk.github.io/adaptr/reference/print.md) method
providing formatted results:
...
[`run_trials()`](https://inceptdk.github.io/adaptr/reference/run_trials.md)
function and performance metrics calculated as above:
