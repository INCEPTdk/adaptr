  ...
  for (p in seq_along(metrics)) {
    ...
    if (substr(cur_metric, 1, 16) == "prob_select_arm_") {
      ...
      cur_fun <- switch(cur_metric,
                        ...
                        size_p75 = function(i) quantile(extr_res$final_n[start_id:i], probs = 0.25, names = FALSE),
                        ...
                        sum_ys_p75 = function(i) quantile(extr_res$sum_ys[start_id:i], probs = 0.25, names = FALSE),
                        ...
                        ratio_ys_p75 = function(i) quantile(extr_res$ratio_ys[start_id:i], probs = 0.25, names = FALSE),
